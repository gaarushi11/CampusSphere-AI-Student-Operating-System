...
import {
  LayoutDashboard, CalendarDays, Brain, Settings, Sparkles,
} from 'lucide-react';
      ...
      <div className="px-4 py-4 border-t border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] text-slate-500 truncate">{mockUser.rollNumber}</p>
          </div>
        </div>
        <Badge
          variant="outline"
          className="mt-2.5 text-[10px] text-cyan-400 border-cyan-500/30 bg-cyan-500/5 w-full justify-center"
        >
          Sem {mockUser.semester} · CSE · CGPA {mockUser.cgpa}
        </Badge>
      </div>
    </aside>
  );
